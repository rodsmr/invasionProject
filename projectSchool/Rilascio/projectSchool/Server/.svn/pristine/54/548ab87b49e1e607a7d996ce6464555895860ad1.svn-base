...
public class TaskPosizionaArmate implements Runnable {
	...
	public TaskPosizionaArmate(Giocatore user, PartitaQuattro partita) {
		this.giocatore = user;
		this.partita = partita;
	}
	public TaskPosizionaArmate(Giocatore user, PartitaCinque partita) {
		this.giocatore = user;
		this.partita = partita;
	}
	public TaskPosizionaArmate(Giocatore user, PartitaSei partita) {
		this.giocatore = user;
		this.partita = partita;
	}
	...
	public TaskPosizionaArmate(Client clientInt, Giocatore user, PartitaQuattro partita) {
		this.clientInt = clientInt;
		this.giocatore = user;
		this.partita = partita;
	}
	public TaskPosizionaArmate(Client clientInt, Giocatore user, PartitaCinque partita) {
		this.clientInt = clientInt;
		this.giocatore = user;
		this.partita = partita;
	}
	public TaskPosizionaArmate(Client clientInt, Giocatore user, PartitaSei partita) {
		this.clientInt = clientInt;
		this.giocatore = user;
		this.partita = partita;
	}
	...
	private void sistemaArmate(String posizionamento, int numeroArmate){
		...
		if(posizionamento.equals("posizionate@false")){
			...
			while(iteratoreStati.hasNext()){
				temp = iteratoreStati.next();
				partita.getPosizioneTotale()[(Integer.parseInt(temp.getCodice())-1)] = (temp.getNumArmate()).toString();
				System.out.println("ARMATE INSERITE: "+partita.getPosizioneTotale()[(Integer.parseInt(temp.getCodice())-1)]+ "\t ARMATE PRESE: "+temp.getNumArmate());
			}
